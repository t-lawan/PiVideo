...
# replace `FILENAME.mp4` with your own video
# the options for --aspect-mode are Letterbox, fill and stretch. 
#omxplayer FILENAME.mp4 --loop --no-osd --aspect-mode=letterbox
